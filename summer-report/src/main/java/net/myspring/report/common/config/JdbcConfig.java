package net.myspring.report.common.config;

import com.alibaba.druid.pool.DruidDataSource;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import net.myspring.report.SummerReportApplication;
import net.myspring.report.common.datasource.DynamicDataSource;
...
public class JdbcConfig {
    ...
    public DynamicDataSource dynamicDataSource() {
        ...
        for(String companyName:companyNameList) {
            targetDataSources.put(companyName,getDataSource("spring.datasource.summer-report." + companyName));
        }
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan(ClassUtils.getPackageName(SummerReportApplication.class), ClassUtils.getPackageName(Jsr310JpaConverters.class));
