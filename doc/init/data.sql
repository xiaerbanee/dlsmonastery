...
INSERT INTO `sys_office_rule`(name,code,created_by,created_date,last_modified_by,last_modified_date,remarks,version,locked,enabled,company_id,has_point,parent_id,parent_ids,level)VALUES('主管区域','directorOffice','1','2017-04-26 13:56:21','1','2017-06-26 18:10:41',NULL ,'0','0','1','1','0',1,'0,1,','2');
INSERT INTO `sys_office_rule`(name,code,created_by,created_date,last_modified_by,last_modified_date,remarks,version,locked,enabled,company_id,has_point,parent_id,parent_ids,level)VALUES('考核区域','taskOffice','1','2017-04-26 13:56:21','1','2017-06-26 18:10:41',NULL ,'0','0','1','1','0',2 ,'0,1,2','3');

update sys_office set joint_level="二级";
update sys_office set office_rule_id=1 where type='100';
update sys_office set office_rule_id=2 where type='150';
update sys_office set office_rule_id=3 where type='200';
