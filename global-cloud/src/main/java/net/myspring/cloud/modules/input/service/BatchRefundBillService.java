    ...
    public List<String> save(List<List<Object>> datas) {
        ...
        if (CollectionUtil.isNotEmpty(billList)) {
            for (BatchRefundBillDto arRefundBill : billList) {
                KingdeeSynDto kingdeeSynDto = new KingdeeSynDto(KingdeeFormIdEnum.AR_REFUNDBILL.name(), getARRefundBill(arRefundBill,accountDto));
                String billNo = null;
                billNos.add(billNo);
            }
        }
        ...
        if (CollectionUtil.isNotEmpty(cashBillList)) {
            for (BatchRefundBillDto arRefundBill : cashBillList) {
                KingdeeSynDto kingdeeSynDto = new KingdeeSynDto(KingdeeFormIdEnum.AR_REFUNDBILL.name(), getCashARRefundBill(arRefundBill,accountDto));
                String billNo = null;
                billNos.add(billNo);
            }
        }
