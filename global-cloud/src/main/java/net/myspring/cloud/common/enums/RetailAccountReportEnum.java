 ...
 */
public enum RetailAccountReportEnum {
    ...
    net_profit_1("净利润1","Y14","Y"),
    net_profit_2("净利润2","Y15","Y"),
    net_profit_sum("净利润合计","Y16","Y");
    private String fyName;
    private String fyNum;
    private String accName;

    RetailAccountReportEnum(String fyName, String fyNum, String accName) {
        this.fyName = fyName;
        this.fyNum = fyNum;
