...
let routes = [
  ...
  {path:'/future/layout/adApplyForm',component:adApplyForm,name:'adApplyForm',meta: {menu:"adApplyList"}},
  {path:'/future/layout/adApplyGoods',component:adApplyGoods,name:'adApplyGoods',meta: {menu:"adApplyList"}},
  {path:'/future/layout/adApplyBillForm',component:adApplyBillForm,name:'adApplyBillForm',meta: {menu:"adApplyList"}},
  {path:'/future/layout/adGoodsOrderList',component:adGoodsOrderList,name:'adGoodsOrderList'},
  {path:'/future/layout/adGoodsOrderForm',component:adGoodsOrderForm,name:'adGoodsOrderForm',meta: {menu:"adGoodsOrderList"}},
  ...
  {path:'/future/layout/adPricesystemChangeForm',component:adPricesystemChangeForm,name:'adPricesystemChangeForm',meta: {menu:"adPricesystemChangeList"}},
  {path:'/future/layout/shopAdList',component:shopAdList,name:'shopAdList'},
  {path:'/future/layout/shopAdForm',component:shopAdForm,name:'shopAdForm',meta: {menu:"shopAdList"}},
  ...
  {path:'/future/layout/shopDepositForm',component:shopDepositForm,name:'shopDepositForm',meta: {menu:"shopDepositList"}},
  {path:'/future/layout/shopGoodsDepositList',component:shopGoodsDepositList,name:'shopGoodsDepositList'},
  {path:'/future/layout/shopGoodsDepositForm',component:shopGoodsDepositForm,name:'shopGoodsDepositForm',meta: {menu:"shopGoodsDepositList"}},
  {path:'/future/layout/shopImageList',component:shopImageList,name:'shopImageList'},
  {path:'/future/layout/shopImageForm',component:shopImageForm,name:'shopImageForm',meta: {menu:"shopImageList"}},
  {path:'/future/layout/shopPrintList',component:shopPrintList,name:'shopPrintList'},
  {path:'/future/layout/shopPrintForm',component:shopPrintForm,name:'shopPrintForm',meta: {menu:"shopPrintList"}},
  ...
  {path:'/future/layout/shopPromotionForm',component:shopPromotionForm,name:'shopPromotionForm',meta: {menu:"shopPromotionList"}},
