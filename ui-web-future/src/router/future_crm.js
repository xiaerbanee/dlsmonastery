...
const receivableList = r => require.ensure([], () => r(require('pages/future/crm/receivableList.vue')));
...
const goodsOrderDetailList = r => require.ensure([], () => r(require('pages/future/crm/goodsOrderDetailList.vue')));
...
let routes = [
  ...
  {path:'/future/crm/receivableList',component:receivableList,name:'receivableList',meta: {menu:"receivableList"}},
  ...
  {path: '/future/crm/goodsOrderDetailList',component: goodsOrderDetailList,name:"goodsOrderDetailList"},
