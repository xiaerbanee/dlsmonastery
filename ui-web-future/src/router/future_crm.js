const afterSaleAreaEdit= r => require.ensure([], () => r(require('pages/future/crm/afterSaleAreaEdit.vue')));
...
const goodsOrderStorePrint= r => require.ensure([], () => r(require('pages/future/crm/goodsOrderStorePrint.vue')));
const goodsOrderExpressPrint= r => require.ensure([], () => r(require('pages/future/crm/goodsOrderExpressPrint.vue')));
...
const storeAllotShipPrint= r => require.ensure([], () => r(require('pages/future/crm/storeAllotShipPrint.vue')));
...
let routes = [
  ...
  {path:'/future/crm/expressForm',component:expressForm,name:'expressForm',meta: {menu:"expressList",keepAlive:true}},
  {path:'/future/crm/expressOrderList',component:expressOrderList,name:'expressOrderList'},
  {path:'/future/crm/expressOrderForm',component:expressOrderForm,name:'expressOrderForm',meta: {menu:"expressOrderList",keepAlive:true}},
  ...
  {path:'/future/crm/goodsOrderStorePrint',component:goodsOrderStorePrint,name:'goodsOrderStorePrint',meta: {menu:"goodsOrderShipList",hidden: true}},
  {path:'/future/crm/goodsOrderExpressPrint',component:goodsOrderExpressPrint,name:'goodsOrderExpressPrint',meta: {menu:"goodsOrderShipList",hidden: true}},
  ...
  {path:'/future/crm/reportScoreForm',component:reportScoreForm,name:'reportScoreForm',meta: {menu:"reportScoreList",keepAlive:true}},
