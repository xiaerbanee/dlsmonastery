<template>
  <div>
    ...
    <div>
      ...
      <search-dialog :show="formVisible" @hide="formVisible=false" :title="$t('reportScoreAreaList.filter')" v-model="formVisible" size="tiny" class="search-form"  z-index="1500" ref="searchDialog">
