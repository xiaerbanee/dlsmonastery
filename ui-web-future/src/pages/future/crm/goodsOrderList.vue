  ...
  <div>
    ...
    <div>
      ...
      <el-table :data="page.content" :height="pageHeight" style="margin-top:5px;" v-loading="pageLoading" :row-class-name="tableRowClassName" :element-loading-text="$t('goodsOrderList.loading')" @sort-change="sortChange" stripe border >
        ...
        <el-table-column prop="amount" sortable :label="$t('goodsOrderList.amount')" :formatter="moneyFormatter"></el-table-column>
        <el-table-column prop="shopShouldGetAfterBill" :label="$t('goodsOrderList.shopShouldGet')" :formatter="moneyFormatter"></el-table-column>
