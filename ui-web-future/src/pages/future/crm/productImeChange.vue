<template>
  <div>
    ...
    <search-dialog :show="searchFormVisible" @hide="searchFormVisible=false" :title="$t('productImeChange.filter')" v-model="searchFormVisible" size="tiny" class="search-form" z-index="1500">
      <el-form>
        <el-row :gutter="4">
          <el-col :span="24">
            <el-form-item :label="$t('productImeChange.ime')">
