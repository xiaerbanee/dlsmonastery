<template>
  <div>
    ...
    <search-dialog :show="searchFormVisible" @hide="searchFormVisible=false" :title="$t('productImeChange.filter')" v-model="searchFormVisible" size="small" class="search-form" z-index="1500">
