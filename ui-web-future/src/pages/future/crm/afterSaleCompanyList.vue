<template>
  <div>
    <head-tab active="afterSaleCompanyList"></head-tab>
    <div>
      <el-row>
        <el-button type="primary" @click="itemAdd" icon="plus" v-permit="'crm:afterSale:edit'">换机返厂</el-button>
        <el-button type="primary" @click="itemEdit" icon="edit" v-permit="'crm:afterSale:edit'">好机返库</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      pageRequest() {
        ...
        util.setQuery("afterSaleCompanyList",this.submitData);
