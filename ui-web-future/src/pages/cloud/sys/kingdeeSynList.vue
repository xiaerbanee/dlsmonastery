  ...
  <div>
    ...
    <div>
        ...
        <el-form :model="formData">
            <el-row :gutter="4">
              <el-form-item label="单据编号" :label-width="formLabelWidth">
                <el-input v-model="formData.extendFormatId"  placeholder="请输入"></el-input>
              </el-form-item>
            </el-row>
            <el-row :gutter="4">
      ...
      <el-table :data="page.content" :height="pageHeight" style="margin-top:5px;" v-loading="pageLoading" element-loading-text="拼命加载中....." @sort-change="sortChange" stripe border>
        <el-table-column fixed prop="extendType" label="单据分类" sortable width="120"></el-table-column>
        <el-table-column prop="formId" label="单据类型"></el-table-column>
        <el-table-column prop="extendFormatId" label="单据编号"></el-table-column>
        <el-table-column prop="extendId" label="OA单据ID"></el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="150">
          <template scope="scope">
            <el-button size="small" v-if="!scope.row.status" @click.native="itemAction(scope.row.id,'syn')">重新同步</el-button>
