<template>
  <div>
    ...
    <div>
      <el-row>
        <el-button type="primary" @click="itemAdd" icon="plus" v-permit="'crm:employeePhoneDeposit:edit'">{{$t('employeePhoneDepositList.add')}}</el-button>
        <el-button type="primary"@click="formVisible = true" icon="search" v-permit="'crm:employeePhoneDeposit:view'">{{$t('employeePhoneDepositList.filter')}}</el-button>
        <el-button type="primary" @click="batchPass" icon="check" v-permit="'crm:employeePhoneDeposit:audit'">{{$t('employeePhoneDepositList.batchPass')}}</el-button>
        <el-button type="primary" @click="batchNoPass" icon="close" v-permit="'crm:employeePhoneDeposit:audit'">{{$t('employeePhoneDepositList.batchNoPass')}}</el-button>
        <el-button type="primary" @click="itemBatchAdd" icon="plus" v-permit="'crm:employeePhoneDeposit:edit'">批量添加</el-button>
