<template>
  <div>
    ...
    <div>
      ...
      <search-dialog :title="$t('backendModuleList.filter')" v-model="formVisible" size="tiny" class="search-form" z-index="1500" ref="searchDialog">
        <el-form :model="formData">
          <el-row :gutter="4">
            <el-col :span="24">
              ...
              <el-form-item :label="$t('backendModuleList.backendName')" :label-width="formLabelWidth">
...
<script>
  export default {
    ...
    methods: {
      ...
      axios.get('/api/basic/sys/backendModule/getQuery').then((response) =>{
