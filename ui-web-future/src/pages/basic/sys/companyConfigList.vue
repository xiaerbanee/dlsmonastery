<template>
  <div>
    ...
    <div>
      ...
      <search-dialog @enter="search()" :show="formVisible" @hide="formVisible=false" :title="$t('companyConfigList.filter')"  v-model="formVisible" size="tiny" class="search-form" z-index="1500" ref="searchDialog">
...
<script>
  export default {
    ...
    methods: {
      ...
      this.initPromise = axios.get('/api/basic/sys/companyConfig/getQuery').then((response) =>{
