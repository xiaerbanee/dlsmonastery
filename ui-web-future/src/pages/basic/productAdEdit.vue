<template>
  <div>
    ...
    <div>
      ...
      <search-dialog @enter="search()" :show="formVisible" @hide="formVisible=false" :title="$t('productAdEdit.filter')" v-model="formVisible" size="medium" class="search-form"  z-index="1500" ref="searchDialog">
          ...
          return {
            ...
            settings: {
              ...
              columns: [
                ...
                {data:"price2", type: "numeric",format:"0.000", width: 70},
