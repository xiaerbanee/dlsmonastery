  ...
  <div>
    ...
    <div>
      <el-row>
        ...
        <el-input v-model="password" placeholder="请输入用户密码 " style="width:160px"></el-input>
        <el-button type="primary"@click="formVisible = true" icon="search" v-permit="'sys:dictEnum:view'">{{$t('dictEnumList.filter')}}</el-button>
      </el-row>
      <el-table :data="page" :height="pageHeight" style="margin-top:5px;" v-loading="pageLoading" :element-loading-text="$t('dictEnumList.loading')" @sort-change="sortChange" stripe border>
