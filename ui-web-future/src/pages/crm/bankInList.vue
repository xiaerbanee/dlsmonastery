<template>
  <div>
    ...
    <div>
      ...
      <search-dialog @enter="search()" :show="formVisible" @hide="formVisible=false" :title="$t('bankInList.filter')" v-model="formVisible" size="medium" class="search-form" z-index="1500" ref="searchDialog">
    ...
    methods: {
      ...
      pageRequest() {
        ...
        util.confirmBeforeExportData(this).then(() => {
          ...
          if(row.processStatus === '已通过' || row.processStatus === '未通过'){
              return false;
          }
