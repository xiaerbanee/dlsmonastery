  ...
  export default {
    ...
    data() {
      ...
      remoteSelect(query) {
        ...
        axios.get('/api/ws/future/basic/depotShop/search',{params:{key:query}}).then((response)=>{
        ...
        this.innerId=val;
        this.remoteLoading = true;
        axios.get('/api/ws/future/basic/depotShop/findByIds?id=' + this.innerId).then((response)=>{
          this.itemList=response.data;
          this.remoteLoading = false;
        })
      }
