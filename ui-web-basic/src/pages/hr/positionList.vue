<template>
  <div>
    ...
    <div>
      ...
      <search-dialog @enter="search()" :show="formVisible" @hide="formVisible=false" :title="$t('positionList.filter')" v-model="formVisible" size="tiny" class="search-form" z-index="1500" ref="searchDialog">
        <el-form :model="formData"  :label-width="formLabelWidth">
              <el-form-item :label="$t('positionList.positionName')">
      ...
      <el-table :data="page.content" :height="pageHeight" style="margin-top:5px;" v-loading="pageLoading" :element-loading-text="$t('positionList.loading')" @sort-change="sortChange" stripe border>
        ...
        <el-table-column prop="roleName" :label="$t('positionList.roleName')"></el-table-column>
