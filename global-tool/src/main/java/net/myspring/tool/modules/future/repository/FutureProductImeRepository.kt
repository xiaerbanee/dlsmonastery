...
class FutureProductImeRepository @Autowired constructor(val namedParameterJdbcTemplate: NamedParameterJdbcTemplate){
    ...
    fun findVivoCustomerStockData(dateStart: LocalDate, dateEnd: LocalDate):MutableList<SPlantCustomerStockDto>{
        val map = Maps.newHashMap<String,Any>()
        map.put("dateStart",dateStart)
        map.put("dateEnd",dateEnd)
        val sb = StringBuilder()
        sb.append("""
            select de.area_id as CustomerId,t.product_id as productId,count(*) as useAbleStock ,1 as customerLevel,de.area_id as areaId
            ...
            select de.area_id as CustomerId,im.product_id as productId,count(*) as useAbleStock ,2 as customerLevel,de.area_id as areaId
            ...
            select de.id as CustomerId,im.product_id as productId,count(*) as useAbleStock ,3 as customerLevel,de.area_id as areaId
    ...
    fun findIDVivoCustomerStockData(dateStart: LocalDate, dateEnd: LocalDate):MutableList<SPlantCustomerStockDto>{
        val map = Maps.newHashMap<String,Any>()
        map.put("dateStart",dateStart)
        map.put("dateEnd",dateEnd)
        val sb = StringBuilder()
    ...
    fun findVivoCustomerStockDetailData(dateStart:LocalDate,dateEnd:LocalDate) :MutableList<SPlantCustomerStockDetailDto>{
        val map = Maps.newHashMap<String,Any>()
        map.put("dateStart",dateStart)
        map.put("dateEnd",dateEnd)
        val sb = StringBuilder()
