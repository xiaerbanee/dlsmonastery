...
import net.myspring.general.SummerGeneralApplication;
import net.myspring.general.common.datasource.DynamicDataSource;
...
public class JdbcConfig {
    ...
    public DynamicDataSource dynamicDataSource() {
        ...
        for(String companyName:companyNameList) {
            targetDataSources.put(companyName,getDataSource("spring.datasource.summer-general." + companyName));
        }
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan(ClassUtils.getPackageName(SummerGeneralApplication.class), ClassUtils.getPackageName(Jsr310JpaConverters.class));
