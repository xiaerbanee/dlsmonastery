...
import net.myspring.future.common.datasource.DynamicDataSource;
...
public class JdbcConfig {
    ...
    public DynamicDataSource dynamicDataSource() {
        ...
        for(String companyName:companyNameList) {
            targetDataSources.put(companyName,getDataSource("spring.datasource.ws-future." + companyName));
        }
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan(ClassUtils.getPackageName(WsFutureApplication.class), ClassUtils.getPackageName(Jsr310JpaConverters.class));
