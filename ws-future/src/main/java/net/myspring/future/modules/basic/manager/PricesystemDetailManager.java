...
public class PricesystemDetailManager {
    ...
    @Cacheable(value = "pricesystemDetails",key="#p0")
    public PricesystemDetail findOne(String id) {
        return pricesystemDetailMapper.findOne(id);
    }

    @Cacheable(value = "pricesystemDetails",key="#p0.id")
    ...
    @CachePut(value = "pricesystemDetails",key="#p0.id")
    ...
    @CacheEvict(value = "pricesystemDetails",key="#p0")
