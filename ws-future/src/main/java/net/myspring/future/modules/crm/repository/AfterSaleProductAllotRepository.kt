...
interface AfterSaleProductAllotRepositoryCustom{
    ...
    fun findFilter(afterSaleProductAllotQuery : AfterSaleProductAllotQuery): MutableList<AfterSaleProductAllotDto>
...
class AfterSaleProductAllotRepositoryImpl @Autowired constructor(val namedParameterJdbcTemplate: NamedParameterJdbcTemplate): AfterSaleProductAllotRepositoryCustom {
    override fun findFilter(afterSaleProductAllotQuery: AfterSaleProductAllotQuery): MutableList<AfterSaleProductAllotDto> {
        ...
        return namedParameterJdbcTemplate.query(sb.toString(), BeanPropertySqlParameterSource(afterSaleProductAllotQuery), BeanPropertyRowMapper(AfterSaleProductAllotDto::class.java));
    }
