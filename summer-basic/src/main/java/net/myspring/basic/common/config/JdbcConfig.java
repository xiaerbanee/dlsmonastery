...
public class JdbcConfig {
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan(ClassUtils.getPackageName(SummerBasicApplication.class), ClassUtils.getPackageName(Jsr310JpaConverters.class));
