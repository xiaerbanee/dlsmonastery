<template>
  <div>
    <head-tab :active="$t('productTypeForm.productTypeForm') "></head-tab>
    <div>
    ...
    export default{
      ...
      methods:{
        formSubmit(){
          ...
          form.validate((valid) => {
            if (valid) {
              axios.post('/api/crm/productType/save',qs.stringify(this.inputForm)).then((response)=> {
        ...
        axios.get('/api/crm/productType/getFormProperty').then((response)=>{
          this.formProperty = response.data;
        });
        if(!this.isCreate){
          axios.get('/api/crm/productType/findOne',{params: {id:this.$route.query.id}}).then((response)=>{
